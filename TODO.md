3. Finish blockchain daemon
4. Finish composer structs
5. Finish finish composer syntax application
...
7. Create blockchain repository and service on top of database application
8. Create blockchain module application
9. Create blockchain language application
10. Finish the syntax's program and execute methods in the syntax action application
11. Create tests in scripts to test the blockchain application
----
