...
func (app *grammar) elementFromEverything(everything grammars.Everything, cardinality cardinalities.Cardinality) grammars.Element {
...
func (app *grammar) everything(name string, exception grammars.Token, escape grammars.Token) grammars.Everything {
	ins, err := app.everythingBuilder.Create().
		WithName(name).
