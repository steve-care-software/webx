...
import (
	...
	layers_bytes "github.com/steve-care-software/datastencil/domain/instances/libraries/links/layers/instructions/assignments/assignables/bytes"
	...
	conditions_resources "github.com/steve-care-software/datastencil/domain/instances/libraries/links/elements/conditions/resources"
	...
	links_resources "github.com/steve-care-software/datastencil/domain/instances/libraries/links/origins/resources"
)
		...
		"library_layer_instruction": {
			{
				...
				instance: instructions.NewInstructionWithAssignmentForTests(
					assignments.NewAssignmentForTests(
						"myName",
						assignables.NewAssignableWithBytesForTests(
							layers_bytes.NewBytesWithHashBytesForTests("myInput"),
		...
		"library_layer_instruction_assignment": {
			{
				...
				instance: assignments.NewAssignmentForTests(
					"myName",
					assignables.NewAssignableWithBytesForTests(
						layers_bytes.NewBytesWithHashBytesForTests("myInput"),
					),
