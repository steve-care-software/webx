...
type Application interface {
	...
	Transact(blockchain blockchains.Blockchain, content contents.Content, signer signers.Signer) error // add a transaction to the provided blockchain
	Queue(blockchain blockchains.Blockchain) (transactions.Transactions, error)                        // returns the transaction queue
	Mine(blockchain blockchains.Blockchain) (blocks.Block, error)                                      // mines a block and returns it
