...
func NewIdentityWithAuthenticatedAndCurrentForTests(all storages.Storages, authenticated keys.Keys, current keys.Key) Identity {
...
func NewIdentityWithAuthenticatedForTests(all storages.Storages, authenticated keys.Keys) Identity {
